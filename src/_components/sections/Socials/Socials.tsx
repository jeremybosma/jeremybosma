    ...
    return (
        <div className='titlediv'>
            ...
            <section className="projects" id='contact'>
                <ProjectCard name='jeremybosma_' backgroundColor='#000' icon='/images/x.png' href='https://x.com/jeremybosma_' />
                <ProjectCard name='jeremybosma' backgroundColor='#333' icon='/images/github.png' href='https://github.com/jeremybosma' />
                ...
                <ProjectCard name='jeremybosma' backgroundColor='#11C3FF' icon='/images/kofi.png' href='https://ko-fi.com/jeremybosma' />
            </section>
        </div>
    );
};